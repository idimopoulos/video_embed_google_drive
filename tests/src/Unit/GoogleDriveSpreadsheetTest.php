...
use Drupal\video_embed_google_drive\Plugin\video_embed_field\Provider\GoogleDriveSpreadsheet;
use GuzzleHttp\ClientInterface;

/**
 * Tests the GoogleDocs provider.
 *
 * @coversDefaultClass \Drupal\video_embed_google_drive\Plugin\video_embed_field\Provider\GoogleDriveSpreadsheet
 *
 * @group video_embed_field
 */
class GoogleDriveSpreadsheetTest extends UnitTestCase {
  ...
  public function testGetIdFromInput($url, $expected_id, $expected_embedded) {
    ...
    $document_provider = new GoogleDriveSpreadsheet(['input' => $url], $plugin_definition['id'], $plugin_definition, $this->httpClient);
    $actual_id = GoogleDriveSpreadsheet::getIdFromInput($url);
  ...
  public function testInvalidUrls($url) {
    ...
    new GoogleDriveSpreadsheet(['input' => $url], $plugin_definition['id'], $plugin_definition, $this->httpClient);
  }
  ...
  public function providerTestGetIdFromInput() {
    return [
      'standard direct url' => [
        'https://docs.google.com/spreadsheets/d/S4mpl3_id-with-stuff',
        'S4mpl3_id-with-stuff',
        FALSE,
      ],
      'standard embed url' => [
        'https://docs.google.com/spreadsheets/d/e/C4rc_4-nz0lA/pub',
        'C4rc_4-nz0lA',
        TRUE,
      ],
      'Follow protocol direct url' => [
        '//docs.google.com/spreadsheets/d/aoifsjac484-_ej9f093/pubhtml?widget=true&headers=false',
        'aoifsjac484-_ej9f093',
        FALSE,
      ],
      'No protocol direct url' => [
        'docs.google.com/spreadsheets/d/jasdofijf0348c4-___djafoisjf94',
        'jasdofijf0348c4-___djafoisjf94',
        FALSE,
      ],
      'Follow protocol embedded url' => [
        '//docs.google.com/spreadsheets/d/e/oifjwe89e4j928fj83--_9df984/pubhtml?widget=true&headers=false',
        'oifjwe89e4j928fj83--_9df984',
        TRUE,
      ],
      'No protocol embedded url' => [
        'docs.google.com/spreadsheets/d/e/j93j844_-F_C_F_E_k',
        'j93j844_-F_C_F_E_k',
        TRUE,
      ],
    ];
  ...
  public function providerTestInvalidUrls() {
    return [
      ...
      ['http://docs.google.com/spreadsheets/d/mc049-22c-2ekf-3kfdf'],
      // Non secure embedded url.
      ['http://docs.google.com/spreadsheets/d/e/f349j03c49k0jf'],
      // Missing the /d/.
      ['http://docs.google.com/spreadsheets/jaf9uwrf_dsjfasd-fFJ'],
    ];
  }
